...
const TRACK_CARDS = [
  ...
  },
  {
    ...
    title: 'Quant',
    description:
      'A quantitative and algorithmic strategy track. Members work the full research lifecycle, sourcing data, generating signals, and backtesting systematic ideas with AI-native, agentic tooling.',
    href: '/tracks/quant',
  },
] as const;
